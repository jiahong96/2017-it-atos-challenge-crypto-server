 ...
 * @author CheahHong
 */
public class LocalCryptoServer {
    ...
    private static final String keystoreFilePath = "Kch\\.keystore";
    private static final String certFilePath = "Kch\\Kch.pem";
    private static final String locationFilePath = "Kch\\Kch.txt";
